      ...
      {modalOpen && (
        ...
        >
          <div className="scan-modal-content" onClick={(event) => event.stopPropagation()}>
            <div className="scan-modal-icon" style={{ background: modalTitle === "Emergency Warning" ? 'linear-gradient(135deg, #ff8a9b, #ff6b7a)' : 'linear-gradient(135deg, #38e0b2, #5effd1)', color: modalTitle === "Emergency Warning" ? '#fff' : '#022016' }}>
            ...
            <h3 className="scan-modal-title">{modalTitle}</h3>
            <p className="scan-modal-message">{modalMessage}</p>
