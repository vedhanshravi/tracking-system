        ...
        <div className="dashboard-brand">
          <div className="dashboard-brand-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 13V8C3 7.44772 3.44772 7 4 7H6L8 4H16L18 7H20C20.5523 7 21 7.44772 21 8V13C21 13.5523 20.5523 14 20 14H19.5C19.2239 15.1634 18.2672 16.0934 17.0577 16.2951C16.8625 16.3341 16.6655 16.3538 16.4684 16.3544H7.53163C7.13465 16.3544 6.74938 16.2866 6.38784 16.1589C5.0805 15.7473 4.22727 14.465 4.07054 13.0337C4.02808 12.7028 3.87599 12.3864 3.63604 12.1518C3.39609 11.9172 3.08403 11.7833 2.75924 11.7749C2.43445 11.7665 2.12764 11.8844 1.88847 12.1096C1.6493 12.3349 1.49824 12.6452 1.46739 12.9697C1.43654 13.2942 1.52708 13.6148 1.72337 13.8775C1.91966 14.1402 2.20786 14.3271 2.5362 14.4043C2.86454 14.4815 3.21475 14.4427 3.52179 14.2955C3.82884 14.1483 4.07952 13.9003 4.22584 13.5901L4.3 13.4H4C3.44772 13 3 12.5523 3 12Z" fill="white"/>
              <path d="M6.5 18C5.67157 18 5 17.3284 5 16.5C5 15.6716 5.67157 15 6.5 15C7.32843 15 8 15.6716 8 16.5C8 17.3284 7.32843 18 6.5 18Z" fill="#0F172A"/>
              <path d="M17.5 18C16.6716 18 16 17.3284 16 16.5C16 15.6716 16.6716 15 17.5 15C18.3284 15 19 15.6716 19 16.5C19 17.3284 18.3284 18 17.5 18Z" fill="#0F172A"/>
            </svg>
          </div>
          <div>
